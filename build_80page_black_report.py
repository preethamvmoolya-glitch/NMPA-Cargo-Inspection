...
def generate_80_page_black_report():
    doc = docx.Document()
    ...
    # PURE BLACK HEADING HELPER (Times New Roman, Pure Black 0,0,0, 1.15 line spacing)
    ...
    # PURE BLACK PARAGRAPH HELPER (Times New Roman 12pt, Pure Black 0,0,0, 1.15 line spacing)
    ...
    # BULLET POINT HELPER (Times New Roman 12pt, Pure Black 0,0,0, 1.15 line spacing)
    ...
    # IMAGE / CAPTION HELPER (Pure Black text)
    ...
    # TABLE HELPER (Pure Black text & borders)
    def add_tbl(col_widths, headers, rows_data):
        ...
        for i, title in enumerate(headers):
            ...
            set_cell_background(hdr_cells[i], "E6E6E6") # Light monochrome grey for headers
    ...
    print("Setup helper functions compiled successfully.")
    return doc
