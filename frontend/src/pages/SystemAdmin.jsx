              ...
              children: (
                <div>
                  ...
                  <Row gutter={24}>
                    ...
                    <Col span={24}>
                      <Card title={t('breakdownChartTitle')} style={{ height: '320px' }}>
                              ...
                              {(clearedCount + rejectedCount) > 0 ? (
                                <>
                                  <circle
                                    ...
                                    stroke="#52c41a"
                                    strokeWidth="12"
                                    strokeDasharray={`${(clearedCount / (clearedCount + rejectedCount || 1)) * 301.59} 301.59`}
                                    strokeLinecap="round"
                                  />
                                  <circle
                                    cx="60"
                                    ...
                                    stroke="#ff4d4f"
                                    strokeWidth="12"
                                    strokeDasharray={`${(rejectedCount / (clearedCount + rejectedCount || 1)) * 301.59} 301.59`}
                                    strokeDashoffset={-((clearedCount / (clearedCount + rejectedCount || 1)) * 301.59)}
                                    strokeLinecap="round"
                                  />
                                </>
                              ) : null}
                          ...
                          <div style={{ display: 'flex', flexDirection: 'column', gap: '15px', minWidth: '180px' }}>
                            <div>
                              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
                                ...
                                <Text strong style={{ fontSize: '14px' }}>{t('splitsApprovedAccess')}</Text>
                              </div>
                              <Text type="secondary" style={{ marginLeft: '20px' }}>
                                {clearedCount} {language === 'en' ? 'Vessels Cleared' : 'जहाज स्वीकृत'}
                              </Text>
                            </div>
                            ...
                            <div>
                              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
                                ...
                                <Text strong style={{ fontSize: '14px' }}>{t('splitsDetainedAccess')}</Text>
                              </div>
                              <Text type="secondary" style={{ marginLeft: '20px' }}>
                                {rejectedCount} {language === 'en' ? 'Vessels Detained' : 'जहाज निरुद्ध'}
                              </Text>
                            </div>
                          </div>
                        </div>
